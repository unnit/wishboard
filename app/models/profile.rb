class Profile < ActiveRecord::Base
  ...
  def enabled_hours
    init_availability if open_time.blank? || close_time.blank?
    start_hour = open_time.split(":").first.to_i
    close_hour = close_time.split(":").first.to_i
    (start_hour..close_hour).to_a
  end
