namespace :coco_tasks do
  ...
  task add_countries_with_phonecode: :environment do
    country_list = [
        ...
        [8, 'AQ', 'ANTARCTICA', 'Antarctica', nil, nil, 0],
        ...
        [29, 'BV', 'BOUVET ISLAND', 'Bouvet Island', nil, nil, 0],
        [30, 'BR', 'BRAZIL', 'Brazil', 'BRA', 76, 55],
        [31, 'IO', 'BRITISH INDIAN OCEAN TERRITORY', 'British Indian Ocean Territory', nil, nil, 246],
        ...
        [45, 'CX', 'CHRISTMAS ISLAND', 'Christmas Island', nil, nil, 61],
        [46, 'CC', 'COCOS [KEELING] ISLANDS', 'Cocos [Keeling] Islands', nil, nil, 672],
        ...
        [76, 'TF', 'FRENCH SOUTHERN TERRITORIES', 'French Southern Territories', nil, nil, 0],
        ...
        [93, 'HM', 'HEARD ISLAND AND MCDONALD ISLANDS', 'Heard Island and Mcdonald Islands', nil, nil, 0],
        ...
        [137, 'YT', 'MAYOTTE', 'Mayotte', nil, nil, 269],
        ...
        [164, 'PS', 'PALESTINIAN TERRITORY, OCCUPIED', 'Palestinian Territory, Occupied', nil, nil, 970],
        ...
        [189, 'CS', 'SERBIA AND MONTENEGRO', 'Serbia and Montenegro', nil, nil, 381],
        ...
        [198, 'GS', 'SOUTH GEORGIA AND THE SOUTH SANDWICH ISLANDS', 'South Georgia and the South Sandwich Islands', nil, nil, 0],
        ...
        [212, 'TL', 'TIMOR-LESTE', 'Timor-Leste', nil, nil, 670],
        ...
        [227, 'UM', 'UNITED STATES MINOR OUTLYING ISLANDS', 'United States Minor Outlying Islands', nil, nil, 1],
